...
// update luckyNumber to test question #14
luckyNumber = 2;
console.log('My new lucky number is', luckyNumber);
...
let goAdventure = adventurous? 'Adventures are great!' : 'How about we stay home?';
console.log(goAdventure);
